    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jurisdiccion', models.CharField(blank=True, max_length=100, null=True, verbose_name='Jurisdiccion')),
                ('regional', models.IntegerField(blank=True, null=True, verbose_name='Regional')),
