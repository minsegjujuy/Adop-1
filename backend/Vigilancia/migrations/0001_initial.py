...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Ente',
            fields=[
                ('categoria_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='Personal.categoria')),
            ],
            options={
                'abstract': False,
            },
            bases=('Personal.categoria',),
        ),
        migrations.CreateModel(
            name='Motivo',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_ente', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='Vigilancia.ente')),
                ('fk_funcionario', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='Personal.funcionario')),
