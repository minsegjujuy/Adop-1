    ...
    onSubmit: async (formValue) => {
      try {
        ...
        // console.log(dia_semana)
          ...
          let turnos2 = [];
          if ((formValue.lunes === true) && (dianuevo<=1)) {
            turnos2.push("lunes")
          }
          if ((formValue.martes === true) && (dianuevo<=2) ){
            turnos2.push("martes")
          }
          if ((formValue.miercoles === true) && (dianuevo<=3)) {
            turnos2.push("miercoles")
          }
          if ((formValue.jueves === true) && (dianuevo<=4)) {
            turnos2.push("jueves")
          }
          if ((formValue.viernes === true) && (dianuevo<=5)) {
            turnos2.push("viernes")
          }
          if ((formValue.sabado === true) && (dianuevo<=6)) {
            turnos2.push("sabado")
          }
          if ((formValue.domingo === true) && (dianuevo<=7)) {
        ...
        const formValue2 = {
          ...
          turno:[fecha_fin? {cant_semanas:cant_semanas}:1,{primer_semana:turnos},{semanas_intermedia:turnos_media},fecha_fin? {ultima_semana:ultima_semana}:[]],
